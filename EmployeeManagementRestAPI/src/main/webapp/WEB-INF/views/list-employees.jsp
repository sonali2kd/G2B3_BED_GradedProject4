...
<body>
	...
	<div class="container">
		...
		<!-- Add a button -->
		<a href="/emra/employees/showFormForAdd"
			class="btn btn-primary btn-sm mb-3"> Add Employee </a> <a
			href="/emra/logout" class="btn btn-primary btn-sm mb-3 mx-auto">
			Logout </a>
				...
				<c:forEach items="${Employees}" var="tempEmployee">
					<tr>
						...
						<td>
							...
							<c:url var="updateUrl"
								value="/employees/showFormForUpdate?employeeId=${tempEmployee.id}" />

							<a href="${updateUrl}" class="btn btn-info btn-sm"> Update </a> <c:url
								var="deleteUrl"
								value="/employees/delete?employeeId=${tempEmployee.id}" /> <a
